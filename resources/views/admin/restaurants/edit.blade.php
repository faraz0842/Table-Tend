                ...
                <div id="kt_app_toolbar_container" class="app-container d-flex flex-stack">
                    <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                        ...
                        <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                            ...
                            <li class="breadcrumb-item text-muted">{{ __('edit_restaurant') }}</li>
                        </ul>
                    </div>
                </div>
            </div>
            <div id="kt_app_content" class="app-content flex-column-fluid">
                <div id="kt_app_content_container" class="app-container">
                    ...
                    <form class="form d-flex flex-column flex-lg-row" method="POST" enctype="multipart/form-data"
                        action="{{ route('restaurant.update', $restaurant->slug) }}">
                        @csrf
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 fv-row fv-plugins-icon-container">
                                            ...
                                            <select class="form-select" name="cuisines[]" multiple data-control="select2"
                                                ...
                                                @foreach ($cuisines as $cuisine)
                                                    <option
                                                        value="{{ $cuisine['id'] }}"{{ $restaurant['cuisine'] == $cuisine['id'] ? $cuisine['name'] : '' }}>
                                                        {{ $cuisine['name'] }}</option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="col-lg-4 fv-row fv-plugins-icon-container">
                                            ...
                                            <input type="number" name="delivery_range"
                                                class="form-control"value="{{ old('delivery_range', $restaurant['delivery_range']) }}"
                                        ...
                                        <div class="col-lg-4 fv-row fv-plugins-icon-container">
                                            ...
                                            <input type="number" name="default_tax" class="form-control"
                                                value="{{ old('default_tax', $restaurant['default_tax']) }}"
                                        ...
                                        <div class="col-lg-6 fv-row fv-plugins-icon-container">
                                            ...
                                            <input type="number" name="phone"
                                                class="form-control"value="{{ old('phone', $restaurant['phone']) }}"
                                        ...
                                        <div class="col-lg-6 fv-row fv-plugins-icon-container">
                                            ...
                                            <input type="number" name="mobile"
                                                class="form-control"value="{{ old('mobile', $restaurant['mobile']) }}"
                                        ...
                                        <div class="col-lg-6 fv-row fv-plugins-icon-container">
                                            ...
                                            <input type="number" name="longitude"
                                                class="form-control"value="{{ old('longitude', $restaurant['longitude']) }}"
                                        ...
                                        @foreach (config('translatable.locales') as $translation)
                                            <div class="col-lg-12 fv-row fv-plugins-icon-container">
                                                ...
                                                <input type="text" name="{{ $translation }}[name]"
                                                    ...
                                                    value="{{ old($translation . '.name', $restaurant->hasTranslation($translation) ? $restaurant->translate($translation)->name : '') }}">
                                            ...
                                            <div class="col-lg-12 fv-row fv-plugins-icon-container">
                                                ...
                                                <input type="text" name="{{ $translation }}[address]"
                                                    ...
                                                    value="{{ old($translation . '.address', $restaurant->hasTranslation($translation) ? $restaurant->translate($translation)->address : '') }}">
                                            ...
                                            <div class="col-lg-12 fv-row fv-plugins-icon-container">
                                                <label
                                                    ...
                                                    ({{ $translation }})</label>
                                                <textarea name="{{ $translation }}[description]" class="kt_docs_ckeditor_classic">{{ old($translation . '.description', $restaurant->hasTranslation($translation) ? $restaurant->translate($translation)->description : '') }}</textarea>
                                            ...
                                            <div class="col-lg-12 fv-row fv-plugins-icon-container">
                                                <label
                                                    ...
                                                    ({{ $translation }})</label>
                                                <textarea name="{{ $translation }}[information]" class="kt_docs_ckeditor_classic">{{ old($translation . '.information', $restaurant->hasTranslation($translation) ? $restaurant->translate($translation)->information : '') }}</textarea>
                                        ...
                                        @can('admin')
                                            ...
                                            <div class="col-lg-6 fv-row fv-plugins-icon-container">
                                                ...
                                                <select class="form-select" name="users" data-control="select2"
                                                    ...
                                                    @foreach ($managers as $manager)
                                                        <option
                                                            value="{{ $manager['id'] }}"{{ $restaurant['user'] == $manager['id'] ? selected : '' }}>
                                                            {{ $manager['name'] }}</option>
                                                    @endforeach
                                                </select>
                                                @if ($errors->has('users'))
                                            ...
                                            <div class="col-lg-6 fv-row fv-plugins-icon-container">
                                                ...
                                                <input type="number" name="admin_commission"
                                                    class="form-control"value="{{ old('admin_commission', $restaurant['admin_commission']) }}"
                                            ...
                                            <div class="col-lg-12 row fv-plugins-icon-container">
                                                <div class="col-lg-4 fv-row fv-plugins-icon-container">
                                                    ...
                                                    <input class="form-check-input mt-3" type="checkbox"
                                                        {{ $restaurant['closed'] == 1 ? 'checked' : '' }} name="closed" />
                                                ...
                                                <div class="col-lg-4 fv-row fv-plugins-icon-container">
                                                    ...
                                                    <input class="form-check-input mt-3" type="checkbox"
                                                        {{ $restaurant['availability_for_delivery'] == 1 ? 'checked' : '' }}
                                                ...
                                                <div class="col-lg-4 fv-row fv-plugins-icon-container">
                                                    ...
                                                    <input class="form-check-input mt-3" type="checkbox"
                                                        {{ $restaurant['active'] == 1 ? 'checked' : '' }} name="active" />
