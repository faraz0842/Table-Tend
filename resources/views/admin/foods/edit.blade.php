                ...
                <div id="kt_app_toolbar_container" class="app-container d-flex flex-stack">
                    <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                        ...
                        <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                            ...
                            <li class="breadcrumb-item text-muted">{{ __('edit_foods') }}</li>
                        </ul>
                    </div>
                </div>
            </div>
            <div id="kt_app_content" class="app-content flex-column-fluid">
                <div id="kt_app_content_container" class="app-container">
                    ...
                    <form class="form d-flex flex-column flex-lg-row" method="POST" enctype="multipart/form-data"
                        action="{{ route('food.update', $food->slug) }}">
                        @csrf
                            ...
                            <div class="card card-flush py-4">
                                ...
                                <div class="card-body text-center pt-0">
                                    <div class="image-input image-input-empty image-input-outline image-input-placeholder mb-3"
                                        ...
                                        <div class="image-input-wrapper w-150px h-150px" style="background-image: url({{$food->getFirstMediaUrl('food.images')}})"></div>
                                        <label
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 fv-row fv-plugins-icon-container">
                                            ...
                                            <input type="text" name="slug" class="form-control"
                                                placeholder="{{ __('enter_slug') }}" value="{{ $food['slug'] }}">
                                            @if ($errors->has('slug'))
                                        ...
                                        @foreach (config('translatable.locales') as $translation)
                                            <div class="col-lg-12 fv-row fv-plugins-icon-container">
                                                ...
                                                <input type="text" name="{{ $translation }}[name]" class="form-control"
                                                    ...
                                                    value="{{ old($translation . '.name', $food->hasTranslation($translation) ? $food->translate($translation)->name : '') }}">
                                            ...
                                            <div class="col-lg-12 fv-row fv-plugins-icon-container">
                                                ...
                                                <div class="flex-grow-1">
                                                    <!--begin::Block-->
                                                    <div>
                                                        <textarea name="{{ $translation }}[description]" class="kt_docs_ckeditor_classic">{{ old($translation . '.description', $food->hasTranslation($translation) ? $food->translate($translation)->description : '') }}</textarea>
                                                    </div>
                                            ...
                                            <div class="col-lg-12 fv-row fv-plugins-icon-container">
                                                ...
                                                <div class="flex-grow-1">
                                                    <!--begin::Block-->
                                                    <div>
                                                        <textarea name="{{ $translation }}[ingredients]" class="kt_docs_ckeditor_classic">{{ old($translation . '.description', $food->hasTranslation($translation) ? $food->translate($translation)->description : '') }}</textarea>
                                                    </div>
                                        ...
                                        <div class="col-lg-6 fv-row fv-plugins-icon-container">
                                            ...
                                            <input type="number" name="price" class="form-control"
                                                placeholder="{{ __('price') }}" value="{{ $food['price'] }}" />
                                            @if ($errors->has('price'))
                                        ...
                                        <div class="col-lg-6 fv-row fv-plugins-icon-container">
                                            ...
                                            <select class="form-select" data-control="select2" name="unit_id"
                                                ...
                                                @foreach ($units as $unit)
                                                    <option value="{{ $unit['id'] }}" {{ $food['unit_id'] == $unit['id'] ? 'selected' : '' }}>
                                        ...
                                        <div class="col-lg-6 fv-row fv-plugins-icon-container">
                                            ...
                                            <input type="number" name="weight" class="form-control"
                                                placeholder="{{ __('weight') }}" value="{{ $food['weight'] }}" />
                                        ...
                                        <div class="col-lg-6 fv-row fv-plugins-icon-container">
                                            ...
                                            <select class="form-select" data-control="select2" name="category_id"
                                                ...
                                                @foreach ($categories as $category)
                                                    <option value="{{ $category['id'] }}" {{ $food['caegory_id'] == $category['id'] ? 'selected' : '' }}>
                                        ...
                                        <div class="col-lg-6 fv-row fv-plugins-icon-container mt-6">
                                            ...
                                            <input class="form-check-input mt-3" type="checkbox" name="featured"
                                                id="kt_roles_select_all" {{ $food['featured'] == 1 ? 'checked' : '' }} />
                                            ...
                                            <input class="form-check-input mt-3" type="checkbox" name="deliverable"
                                                id="kt_roles_select_all" {{ $food['deliverable'] == 1 ? 'checked' : '' }} />
                                        </div>
                                    </div>
                                </div>
                            </div>
