                ...
                <div id="kt_app_toolbar_container" class="app-container d-flex flex-stack">
                    <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                        ...
                        <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                            ...
                            <li class="breadcrumb-item text-muted">{{ __('edit_categories') }}</li>
                        </ul>
                    </div>
                </div>
            </div>
                            ...
                            <div class="card card-flush py-4">
                                ...
                                <div class="card-body text-center pt-0">
                                    <div class="image-input image-input-empty image-input-outline image-input-placeholder mb-3"
                                        ...
                                        <div class="image-input-wrapper w-150px h-150px" style="background-image: url({{$category->getFirstMediaUrl('category.images')}})"></div>
                                        <label
                                    ...
                                    <div class="text-muted fs-7">{{ __('set the thumbnail. Only *.png, *.jpg and *.jpeg image files are accepted') }}
                                    </div>
                                    @if ($errors->has('image'))
                            ...
                            <div class="card card-flush py-4">
                                ...
                                <div class="card-body pt-0">
                                    <div class="col-lg-12 fv-row fv-plugins-icon-container">
                                        <label
                                            class="col-lg-12 col-form-label required fw-bold fs-6">{{ __('category_slug') }}</label>
                                    ...
                                    @foreach (config('translatable.locales') as $translation)
                                        <div class="col-lg-12 fv-row fv-plugins-icon-container">
                                            <label
                                                class="col-lg-12 col-form-label required fw-bold fs-6">{{ __('category_name') }}
                                                ({{ $translation }})
                                            </label>
                                            <input type="text" name="{{ $translation }}[name]" class="form-control"
                                                placeholder="{{ __('enter_category_name') }}"
                                                value="{{ old($translation . '.name', $category->hasTranslation($translation) ? $category->translate($translation)->name : '') }}">
                                        ...
                                        <div class="col-lg-12 fv-row fv-plugins-icon-container">
                                            <label class="col-lg-12 col-form-label fw-bold fs-6">{{ __('description') }}
                                                ({{ $translation }})</label>
                                            <textarea name="{{ $translation }}[description]" class="kt_docs_ckeditor_classic">{{ old($translation . '.description', $category->hasTranslation($translation) ? $category->translate($translation)->description : '') }}</textarea>
