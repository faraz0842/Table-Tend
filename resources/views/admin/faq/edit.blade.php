                ...
                <div id="kt_app_toolbar_container" class="app-container d-flex flex-stack">
                    <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                        ...
                        <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                            ...
                            <li class="breadcrumb-item text-muted">{{ __('edit_faq') }}</li>
                        </ul>
                    </div>
                </div>
            </div>
            <div id="kt_app_content" class="app-content flex-column-fluid">
                <div id="kt_app_content_container" class="app-container">
                    ...
                    <form class="form d-flex flex-column flex-lg-row" method="POST" enctype="multipart/form-data"
                        action="{{ route('faq.update', $faq->slug) }}">
                        @csrf
                                ...
                                <div class="card-body row pt-0">
                                    <div class="col-lg-6 fv-row fv-plugins-icon-container">
                                        ...
                                        <input type="text" name="slug" class="form-control"
                                            placeholder="{{ __('enter_slug') }}" value="{{ old('slug', $faq->slug) }}">
                                        @if ($errors->has('slug'))
                                    ...
                                    <div class="col-lg-6 fv-row fv-plugins-icon-container">
                                        ...
                                        <select class="form-select" name="faq_category_id" data-control="select2"
                                            ...
                                            @foreach ($faqCategories as $faqCategory)
                                                <option
                                                    value="{{ $faqCategory['id'] }}"{{ $faq->faq_category_id == $faqCategory->id ? 'selected' : '' }}>
                                    ...
                                    @foreach (config('translatable.locales') as $translation)
                                        <div class="col-lg-6 fv-row fv-plugins-icon-container">
                                            ...
                                            <input type="text" name="{{ $translation }}[question]" class="form-control"
                                                ...
                                                value="{{ old($translation . '.question', $faq->hasTranslation($translation) ? $faq->translate($translation)->question : '') }}">
                                        ...
                                        <div class="col-lg-6 fv-row fv-plugins-icon-container">
                                            ...
                                            <textarea type="text" name="{{ $translation }}[answer]" class="form-control"
                                                placeholder="{{ __('enter_answer') }}" rows="1">{{ old($translation . '.answer', $faq->hasTranslation($translation) ? $faq->translate($translation)->answer : '') }}</textarea>
