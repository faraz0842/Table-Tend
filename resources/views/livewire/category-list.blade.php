        ...
        <div class="card-title">
            <div class="d-flex align-items-center position-relative my-1">
                ...
                <input type="text" wire:model="searchName" class="form-control form-control-solid w-250px ps-15"
                    placeholder="{{ __('search_categories') }}" />
            </div>
        </div>
        @can('category.create')
                    ...
                    <tr class="text-center">
                        ...
                        <td>
                            ...
                            <div class="symbol symbol-rounded symbol-50px overflow-hidden me-3">
                                <img src="{{ ImageHelper::GetImageUrl($category->getFirstMediaUrl('category.images')) }}"
                                    class="w-100" />
                            </div>
                            <!--end::Avatar-->
                        </td>
                        ...
                        <td class="text-dark">
                            ...
                            @endcan
                            @can('category.delete')
                                <button data-bs-toggle="modal" data-bs-target="#kt_modal_{{ $category->slug }}"
                                    class="btn btn-icon btn-danger btn-sm mr-2">
                                    <i class="bi bi-trash fs-4"></i>
                                </button>
                            @endcan
                            <div class="modal fade" tabindex="-1" id="kt_modal_{{ $category->slug }}">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer d-flex justify-content-center">
                                            <button type="button" class="btn btn-light"
                                                ...
                                                {{ __('cancel') }}</button>
                                            <a href="{{ route('category.delete', $category->slug) }}" type="button"
