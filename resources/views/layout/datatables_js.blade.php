...
<script type="text/javascript"
    src="{{ asset('https://cdn.datatables.net/colreorder/1.5.0/js/dataTables.colReorder.js') }}"></script>
<script type="text/javascript"
    src="{{ asset('https://cdn.datatables.net/responsive/2.2.2/js/dataTables.responsive.js') }}"></script>
<script type="text/javascript" src="{{ asset('https://cdn.datatables.net/rowgroup/1.0.3/js/dataTables.rowGroup.js') }}">
</script>
...
<script type="text/javascript">
    ...
    function renderButtons(tableId) {
        ...
        $("#" + tableId + "_filter").html("<div class=\"input-group input-group-sm\">\n" +
            "  <input type=\"text\" value=\"" + dtable.state().search.search +
            "\" class=\"form-control\" placeholder=\"{{ trans('lang.search') }}\" aria-label=\"{{ trans('lang.search') }}\">\n" +
    ...
    $('.table-responsive thead tr th').each(function() {
        $(this).addClass('thead text-center text-black fst-italic fw-bold fs-7 text-uppercase')
    })
    $('.table-responsive table ').each(function() {
        $(this).addClass("table align-middle table-rounded table-striped border text-center fs-6  gy-5")
    })
    $('.table-responsive table th td').each(function() {
        $(this).addClass("px-3")
    })
</script>
